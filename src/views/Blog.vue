									...
									<div class="row">
										<div class="col-lg-8 col-md-6 col-sm-12">
											<div class="row">
												...
												<div class="col-lg-6 col-md-12" v-if="currentPosts.length > 2">
													<router-link
												...
												<div class="col-lg-6 col-md-12" v-if="currentPosts.length > 3">
													<router-link
										...
										<div class="col-lg-4 col-md-6 col-sm-12" v-if="currentPosts.length > 4">
											<div class="row">
												<div class="col-12">
													<router-link
